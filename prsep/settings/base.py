"""
Django settings for prsep project.
...
SECRET_KEY = "django-insecure-a%!!z9$&zosed-v4nt(_u^*rl6ups&nqw9j4pl*1u(7056vz&p"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['192.168.201.28','localhost','smartshopper.uno']
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "planification.context_processors.exercice_params"
            ],
        },
    },
]
